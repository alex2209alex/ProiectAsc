...
fileOutput = open("cerinta2_parola_10_output.txt", "w")
...
"""
    Se observa in fisierul cerinta2_parola_10_output.txt ca niciun caracter eligibil nu se poate afla pe prima pozitie a parolei de lungime 10 deoarece dau caractere invalide
cand incerc sa decriptez partial fisierul. Din aceasta cauza se poate determina ca parola nu are lungime 10.
"""